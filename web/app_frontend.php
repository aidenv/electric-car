...
$loader = require_once __DIR__.'/../app/frontend/bootstrap.php.cache';
 ...
 */
//$apcLoader = new ApcClassLoader('yilinker_online_frontend', $loader);
//$loader->unregister();
//$apcLoader->register(true);

//require_once __DIR__.'/../app/frontend/FrontendKernel.php';
require_once __DIR__.'/../app/frontend/FrontendCache.php';
$GLOBALS['application_env'] = 'frontend';
$kernel = new FrontendKernel('prod', false);
$kernel->loadClassCache();
$kernel = new FrontendCache($kernel);
