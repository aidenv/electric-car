...
(function ($){
    ...
    var segment = Routing.generate("user_affiliate_landing_page") + "/" + pathArray[2];
    ...
    if(segment == Routing.generate("user_affiliate_forgot_password_request")){
    ...
    $(".login-tab-selection a").click(function() {
        ...
        if (!$(this).hasClass("active")) {
            ...
            if(tabLink == "login-form"){
                window.history.pushState({},"", Routing.generate("user_affiliate_login"));
            }
            else if(tabLink == "register-form"){
                window.history.pushState({},"", Routing.generate("user_affiliate_register"));
            }
        }
    ...
    $(document).ready(function () {
        ...
        $('#merchant-sign-in').on('click', function () {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    $this.html("<div class='ui active centered small inline inverted loader'>&nbsp;</div>").attr("disabled", true);
                },
                success: function (response) {
                    ...
                    if (response.success == true) {
                        ...
                        $this.html("Sign In").attr("disabled", false);
