 ...
 */
class ManufacturerPayoutDocumentListener
{
    ...
    public function prePersist(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof ManufacturerPayoutDocument) {
    ...
    private function upload($entity)
    {
         ...
         */
        $userDirectory = $this->webRootDirectory.DIRECTORY_SEPARATOR.$entity->getUploadDir().DIRECTORY_SEPARATOR.$entity->getManufacturerPayout()->getManufacturerPayoutId();
